...
public abstract class WorldMixin implements WorldInterface {
    ...
    public int getReceivedStrongBluestonePower(BlockPos pos) {
        int i = 0;
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongBluestonePower(pos.down(), Direction.DOWN))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongBluestonePower(pos.up(), Direction.UP))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongBluestonePower(pos.north(), Direction.NORTH))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongBluestonePower(pos.south(), Direction.SOUTH))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongBluestonePower(pos.west(), Direction.WEST))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongBluestonePower(pos.east(), Direction.EAST))) >= 2) {
            return i;
        }
        return i;
    }
    ...
    public int getReceivedStrongGreenstonePower(BlockPos pos) {
        int i = 0;
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongGreenstonePower(pos.down(), Direction.DOWN))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongGreenstonePower(pos.up(), Direction.UP))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongGreenstonePower(pos.north(), Direction.NORTH))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongGreenstonePower(pos.south(), Direction.SOUTH))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongGreenstonePower(pos.west(), Direction.WEST))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongGreenstonePower(pos.east(), Direction.EAST))) >= 2) {
            return i;
        }
        return i;
    }
    ...
    public int getReceivedStrongYellowstonePower(BlockPos pos) {
        int i = 0;
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongYellowstonePower(pos.down(), Direction.DOWN))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongYellowstonePower(pos.up(), Direction.UP))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongYellowstonePower(pos.north(), Direction.NORTH))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongYellowstonePower(pos.south(), Direction.SOUTH))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongYellowstonePower(pos.west(), Direction.WEST))) >= 2) {
            return i;
        }
        if ((i = Math.max(i, ((WorldViewInterface) this).getStrongYellowstonePower(pos.east(), Direction.EAST))) >= 2) {
            return i;
        }
        return i;
    }
