...
public class WallGreenstoneTorchBlock
extends GreenstoneTorchBlock {
    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;
    public static final BooleanProperty LIT = GreenstoneTorchBlock.LIT;

    public WallGreenstoneTorchBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    protected boolean shouldUnpower(World world, BlockPos pos, BlockState state) {
        Direction direction = state.get(FACING).getOpposite();
        return world.isEmittingGreenstonePower(pos.offset(direction), direction);
    }
