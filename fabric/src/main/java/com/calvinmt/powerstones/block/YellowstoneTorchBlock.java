...
public class YellowstoneTorchBlock
extends TorchBlock {
    ...
    protected boolean shouldUnpower(World world, BlockPos pos, BlockState state) {
        return world.isEmittingYellowstonePower(pos.down(), Direction.DOWN);
    }
    ...
    public int getStrongYellowstonePower(BlockState state, BlockView world, BlockPos pos, Direction direction) {
        if (direction == Direction.DOWN) {
            return state.getWeakYellowstonePower(world, pos, direction);
        }
        return 0;
    }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        world.addParticleClient(new DustParticleEffect(PowerColour.YELLOW.getWireColour(15), 1.0F), particlePos.getX(), particlePos.getY(), particlePos.getZ(), 0.0, 0.0, 0.0);
    }
